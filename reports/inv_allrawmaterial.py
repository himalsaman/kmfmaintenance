...
class CreateINVAllRMReport(object):
	def __init__(self):
		"""Constructor"""
		self.width, self.height = A4
		self.styles = getSampleStyleSheet()

		pdfname = 'invALLRM.pdf'
	...
	def create_pdf(self):
		...
		for val in select_all_raw_material():
			...
			line_data = [str(line_num), val.code, val.name, val.string_size, val.inv_qty]
		...
		table = Table(data, colWidths=[50, 80, 180, 100, 70], rowHeights=20
