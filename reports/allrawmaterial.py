...
class CreateAllRMReport(object):
	def __init__(self):
		"""Constructor"""
		self.width, self.height = A4
		self.styles = getSampleStyleSheet()

		pdfname = 'allRawMat.pdf'
	...
	def create_pdf(self):
		...
		text_data = ["#", "RM. Code", "RM. Name", "RM. Size", "RM. Cost", "RM. INV. QTY."]
		d = []
		font_size = 8
		centered = ParagraphStyle(name="centered", alignment=TA_CENTER)
		...
		for val in select_all_raw_material():
			...
			line_data = [str(line_num), val.code, val.name, val.string_size,
		...
		table = Table(data, colWidths=[50, 80, 180, 100, 50, 70], rowHeights=20
