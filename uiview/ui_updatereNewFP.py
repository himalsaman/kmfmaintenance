...
from models.finishProductsModel import update_finish_product
...
class Ui_editFPDialog(QDialog):
	...
	def setupUi(self, editFPDialog):
		...
		self.listWidget.addItem(self.fini.gen_code + " - " + self.fini.name)
		...
		self.statulbl.setGeometry(QtCore.QRect(390, 430, 410, 41))
