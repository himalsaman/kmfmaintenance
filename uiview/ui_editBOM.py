...
class Ui_editBOMDialog(QDialog):
	def __init__(self, mainte):
		super(Ui_editBOMDialog, self).__init__()
		self.mainte = mainte
		self.setupUi(self)
	...
	def setupUi(self, editBOMDialog):
		...
		self.loggedUserlbl = QtWidgets.QLabel(editBOMDialog)
		...
		self.customerMPhonelbl = QtWidgets.QLabel(editBOMDialog)
		...
		self.line_2 = QtWidgets.QFrame(editBOMDialog)
		self.line_2.setGeometry(QtCore.QRect(6, 201, 750, 3))
		self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
		self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
		self.line_2.setObjectName("line_2")
		self.label_10 = QtWidgets.QLabel(editBOMDialog)
		self.label_10.setGeometry(QtCore.QRect(405, 5, 100, 13))
		self.label_10.setObjectName("label_10")
		self.maintenanceCodelbl = QtWidgets.QLabel(editBOMDialog)
		...
		self.label_12 = QtWidgets.QLabel(editBOMDialog)
		self.label_12.setGeometry(QtCore.QRect(602, 6, 47, 10))
		self.label_12.setObjectName("label_12")
		self.bomCodelbl = QtWidgets.QLabel(editBOMDialog)
		...
		self.label_14 = QtWidgets.QLabel(editBOMDialog)
		self.label_14.setGeometry(QtCore.QRect(524, 30, 120, 13))
		self.label_14.setObjectName("label_14")
		self.label_15 = QtWidgets.QLabel(editBOMDialog)
		self.label_15.setGeometry(QtCore.QRect(524, 60, 120, 13))
		self.label_15.setObjectName("label_15")
		self.label_16 = QtWidgets.QLabel(editBOMDialog)
		self.label_16.setGeometry(QtCore.QRect(524, 90, 100, 13))
		self.label_16.setObjectName("label_16")
		self.totalRMCled = QtWidgets.QLineEdit(editBOMDialog)
		...
		self.totalSPCled = QtWidgets.QLineEdit(editBOMDialog)
		...
		self.totalRMSPCled = QtWidgets.QLineEdit(editBOMDialog)
		...
		self.calcinibtn = QtWidgets.QPushButton(editBOMDialog)
		...
		self.savereqdatabtn = QtWidgets.QPushButton(editBOMDialog)
		...
		self.retranslateUi(editBOMDialog)
		QtCore.QMetaObject.connectSlotsByName(editBOMDialog)
		self.tableDataShow()
		self.lablesData()
	...
	def retranslateUi(self, editBOMDialog):
		...
		self.label_5.setText(_translate("editBOMDialog", "Product for Maintenance :"))
		self.label_6.setText(_translate("editBOMDialog", "Maintenance Descreption :"))
		self.label_10.setText(_translate("editBOMDialog", "Maintenance Code :"))
		self.label_12.setText(_translate("editBOMDialog", "BOM ID :"))
		self.label_14.setText(_translate("editBOMDialog", "Total Raw Material Cost :"))
		self.label_15.setText(_translate("editBOMDialog", "Total Spare Parts Cost :"))
		self.label_16.setText(_translate("editBOMDialog", "Total RM & SP Cost :"))
		self.savebtn.setText(_translate("editBOMDialog", "Save"))
		self.label_19.setText(_translate("editBOMDialog", "Total Cost"))
		self.addNewRMbtn.setText(_translate("editBOMDialog", "Add Raw Material"))
		self.label_18.setText(_translate("editBOMDialog", "Other Cost"))
		self.label_17.setText(_translate("editBOMDialog", "Labor Cost"))
		self.closebtn.setText(_translate("editBOMDialog", "Close"))
		self.calcfinbtn.setText(_translate("editBOMDialog", "Add Cost  \n"
															  " Re-Calculate"))
		self.addNewSPbtn.setText(_translate("editBOMDialog", "Add Spare Part"))
		self.calcinibtn.setText(_translate("editBOMDialog", "Refresh"))
		self.savereqdatabtn.setText(_translate("editBOMDialog", "Save Product & Descreption"))
