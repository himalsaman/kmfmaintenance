...
from Control.maintenanceLogic import getMaintenanceStatus, getMaintenanceWaitingDelevary, getMaintenanceUnderProccessing, \
...
class CreateWaitCustConfReport(object):
	def __init__(self):
		"""Constructor"""
	...
	def createDocument(self, canvas, doc):
		...
		ptext = "<font size=10><u><b>Maintenance's Waiting Customer Confirmation </b></u></font>"
		p = Paragraph(ptext, style=normal)
		p.wrapOn(self.c, self.width, self.height)
