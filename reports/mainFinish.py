...
class CreateMaintFinishReport(object):
	def __init__(self):
		"""Constructor"""
	...
	def createDocument(self, canvas, doc):
		...
		ptext = "<font size=10><u><b>Maintenance's Finished and Delivered </b></u></font>"
		p = Paragraph(ptext, style=normal)
		p.wrapOn(self.c, self.width, self.height)
	...
	def create_pdf(self):
		...
		t = Table(data, colWidths=[5, 5, 440, 35, 76], rowHeights=15)
