...
class CreateMaintAmountdReport(object):
	def __init__(self):
		"""Constructor"""
	...
	def createDocument(self, canvas, doc):
		...
		ptext = "<font size=10><u><b>Maintenance's Amounted </b></u></font>"
		p = Paragraph(ptext, style=normal)
		p.wrapOn(self.c, self.width, self.height)
	...
	def create_pdf(self):
		...
		for idx, val in enumerate(getMaintenanceAmouted()):
		...
		t = Table(data, colWidths=[5, 5, 400, 50, 100], rowHeights=15)
